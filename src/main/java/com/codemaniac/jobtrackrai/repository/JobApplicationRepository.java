...
import com.codemaniac.jobtrackrai.dto.JobApplicationLiteDto;
...
public interface JobApplicationRepository
  ...
  @Query("SELECT new com.codemaniac.jobtrackrai.dto.JobApplicationLiteDto(" +
      "a.id, a.company, a.role, a.status, a.appliedDate) " +
      "FROM JobApplication a " +
      "WHERE a.user.id = :userId AND a.audit.recordStatus = :recordStatus")
  List<JobApplicationLiteDto> findLiteByUserIdAndStatus(
