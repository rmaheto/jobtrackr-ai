...
public class GlassdoorSnapshotService {

  @Value("${brightdata.glassdoor.dataset-id}")
  private String datasetId;

  private final BrightDataClient brightDataClient;

  public String requestSnapshot(final String jobUrl) {
    return brightDataClient.requestSnapshotId(datasetId, jobUrl, BrightDataSource.GLASSDOOR);
  }
}
