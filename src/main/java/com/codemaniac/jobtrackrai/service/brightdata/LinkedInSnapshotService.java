...
public class LinkedInSnapshotService {

  @Value("${brightdata.linkedin.dataset-id}")
  private String datasetId;

  private final BrightDataClient brightDataClient;

  public String requestSnapshot(final String jobUrl) {
    return brightDataClient.requestSnapshotId(datasetId, jobUrl, BrightDataSource.LINKEDIN);
  }
}
